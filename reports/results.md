...
The table below compares the baseline models and LightGBM on the held-out test set.
...
| LightGBM | 0.842 | 0.848 | 0.873 | 0.860 | 0.928 | 66 | 16 | 13 | 89 |

## Medical-Risk Focus

The highest-recall model is **XGBoost** with recall **0.902** and **10** false negatives.
